export default function Content() {
  return (
    <div className="relative p-4 w-full md:w-[592px] h-[auto] md:h-[465px] rounded-lg bg-gray-900 text-white">
      <h2 className="text-gray-500 uppercase text-[18px] font-[Work Sans] font-semibold mb-2">
        Day 23/2023
      </h2>
